...
<div class="container mt-3">
    ...
    <div class="row">
      <div class="col-4">
        <a class="btn btn-outline-dark" href="form.adicional.php">Incluir</a>
      ...
      <div class="col-8">
        <form onsubmit="pesquisar(); return false;">
          <div class="input-group">
            <input type="text" class="form-control" id="input_search" placeholder="Teto Solar">
...
?>
<script src="form.adicionais.js"></script>